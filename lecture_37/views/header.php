                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 clearfix">
                            <div class="shop-menu clearfix pull-right">
                                <ul class="nav navbar-nav">
                                    <li><a href="<?php echo(BASE_URL);?>my_account.php"><i class="fa fa-user"></i> Account</a></li>
                                    <li><a href="<?php echo(BASE_URL); ?>signup.php"><i class="fa fa-sign-in"></i>Signup</a></li>
                                    <li><a href="checkout.html"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                    <li><a href="<?php echo(BASE_URL); ?>products/shopping_cart.php"><i class="fa fa-shopping-cart"></i> Cart <?php echo($obj_cart->count);?></a></li>
                                    <li>
                                        <?php
                                        if (isset($_SESSION['obj_user'])) {
                                            echo("<a href='".BASE_URL."process/process_logout.php'><i class='fa fa-lock'></i> Logout</a>");
                                        } else {
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    <li><a href="<?php echo(BASE_URL); ?>products/products.php" class="active">Products</a></li>
