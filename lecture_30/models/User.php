...
//
        $strPath = $_SERVER['DOCUMENT_ROOT'] . "/php315/project/users/userimages/$this->userName/$fileName";

        if (!is_dir($_SERVER['DOCUMENT_ROOT'] . "/php315/project/users/userimages")) {
            if (!mkdir($_SERVER['DOCUMENT_ROOT'] . "/php315/project/users/userimages")) {
                throw new Exception("Faield to creat folder userimages");
            }
        }
        if (!is_dir($_SERVER['DOCUMENT_ROOT'] . "/php315/project/users/userimages/$this->userName")) {
            if (!mkdir($_SERVER['DOCUMENT_ROOT'] . "/php315/project/users/userimages/$this->userName")) {
                throw new Exception("Faield to creat folder userimages/$this->userName");
            }
        }
    ...
    private function getProfile_image() {
        ...
        if (!is_null($data->profile_image)) {
            $uri = "iamges/users/$this->userName/$data->profileImage";
        }
