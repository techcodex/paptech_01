                ...
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form action="process/process_signup.php" method="post">
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" name="user_name" id="user_name" value="<?php echo($obj_user->user_name); ?>" class="user_name" placeholder="User Name">
...
//                                    unset($_SESSION['errors']['user_name']);
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" name="email" id="email" class="email" placeholder="Email" value="<?php echo($obj_user->email); ?>">
