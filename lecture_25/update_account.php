                ...
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form action="<?php echo(BASE_URL); ?>process/process_update_account.php" method="post">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <div>
                                <label>Male: <input type="radio" name="gender[]" style="height: 15px;" value="male"></label>
                                <label> &nbsp;&nbsp;&nbsp;Female: <input type="radio" name="gender[]" style="height: 15px;" value="female"></label>
                            </div>
